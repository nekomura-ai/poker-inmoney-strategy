...
| No | Page | 内容 |
|---:|---|---|
| 1 | [ラベリング実戦チェックポイント](labeling-checkpoints.html) | 序盤で同卓者を観察し、チップを取りやすい人・取りにくい人を見極める |
| 2 | [序盤のテーブルイメージとレンジ設計](early-image-range-strategy.html) | 自分の見え方を設計し、後半のバリューを大きくする |
| 3 | [相手別の見せ方調整戦略](opponent-awareness-image-adjustment.html) | 相手の観察力・技術力・ガッツコール傾向に合わせて見せ方を変える |
| 4 | [ストラクチャー別戦略と目標チップ設計](structure-target-stack.html) | アベレージスタックの1.5〜2倍を基準に、目標スタックを逆算する |
| 5 | [1周2.5BBと最後まであきらめない戦略](orbit-cost-resilience.html) | 1チップ1チェアを合言葉に、最後の1チップまで勝ち筋を拾う |
